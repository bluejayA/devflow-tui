...
## Unit Tests
Run: `cargo test`
Expected: 209 tests pass, 0 failures
...
| app | 35 | Key handling, events, hooks config, render modes |
...
2. Resize terminal to test layout modes:
   ...
   - 120x30: Standard (4 panels)
   - 200x50: Wide (4 panels + Artifacts placeholder + Gate Alert)
